...
namespace PokemonReviewApp.Controllers
{
    ...
    public class ReviewerController : Controller
    {
        ...
        [HttpGet("{reviewerId}/reviews")]       // different at 43min
        [ProducesResponseType(200, Type = typeof(IEnumerable<Reviewer>))]
        [ProducesResponseType(400)]
        ...
        [HttpPut]  // can do [HttpPut("{reviewerId}")] that will be FromPath
        [ProducesResponseType(400)]
        [ProducesResponseType(204)]
        [ProducesResponseType(404)]       // NO setting is FromQuery
        public IActionResult UpdateReviewer(int reviewerId, [FromBody] ReviewerDto updateReviewer)
        {
            ...
            {
                ModelState.AddModelError("", "Something wrong in updating Reviewer");
                return StatusCode(500, ModelState);
            }
        ...
        public IActionResult DeleteReviewer(int reviewerId)
        {
            ...
            {
                ModelState.AddModelError("", "Something wrong in deleting Reviewer");
            }
